const dashboard = {
  ...
  // ─── AIAdvisor ───
  advisor: {
    description: 'Enter your DeepSeek API key to receive a detailed analysis.',
  ...
  optimization: {
    ...
    subtitle: 'Based on your numbers, these improvements would have the biggest impact.',
    currentLabel: 'Current',
    targetLabel: 'Target',
    impactLabel: 'Savings/month',
    noSuggestions: 'Great! All metrics are within optimal ranges.',
    priorityHigh: 'High priority',
    priorityMedium: 'Medium',
    priorityLow: 'Nice to have',
    rentTitle: 'Reduce rent costs',
    rentDesc: 'Rent is {pct}% of revenue — above the 20% threshold.',
    rentTip: 'Renegotiate your lease or look for a more affordable location.',
    cogsTitle: 'Optimize ingredient costs',
    cogsDesc: 'COGS is {pct}% of revenue — above the 35% threshold.',
    cogsTip: 'Negotiate with suppliers, optimize recipes, or find alternative ingredients.',
    wasteTitle: 'Reduce waste & spoilage',
    wasteDesc: 'Waste is at {pct}% of COGS — above the 3% threshold.',
    wasteTip: 'Implement tighter inventory management, FIFO, and portion control.',
    deliveryTitle: 'Negotiate delivery fees',
    deliveryDesc: 'Delivery commission is at {pct}% — could be reduced by 5%.',
    deliveryTip: 'Negotiate lower fees with apps or build your own delivery channel.',
    staffTitle: 'Optimize staffing costs',
    staffDesc: 'Labor is {pct}% of revenue — above the 25% threshold.',
    staffTip: 'Review shift schedules and optimize staffing for peak hours.',
    pricingTitle: 'Increase prices',
    pricingDesc: 'Net margin is only {pct}% — consider a 5% price increase.',
    pricingTip: 'Add combos, upsell options, or adjust prices on low-margin items.',
    volumeTitle: 'Increase customer volume',
    volumeDesc: 'Just a 10% increase in customers would significantly improve profit.',
    volumeTip: 'Boost online marketing, loyalty programs, or expand sales channels.',
    workingCapTitle: 'Increase cash reserves',
    workingCapDesc: 'Reserves only cover {months} months — need at least 3 months.',
    workingCapTip: 'Add {shortfall} to your reserve fund before risks materialize.',
  },
  ...
  costDiagnosis: {
    ...
    subtitle: 'See how each cost category compares to industry benchmarks.',
    categoryLabels: {
      cogs: 'Ingredients',
      rent: 'Rent',
      labor: 'Staff',
    ...
    benchmark: 'Benchmark: {lo}-{hi}%',
    overBenchmark: 'Over benchmark — could save {amount}/month',
  ...
  channelProfit: {
    ...
    subtitle: 'Each channel has different costs. See which ones truly make money.',
    channelLabels: {
      dinein: 'Dine-in',
      takeaway: 'Takeaway',
  ...
  menuMatrix: {
    title: 'Menu analysis',
    subtitle: 'Each item is categorized by how well it sells and how much profit it generates.',
    categories: {
      star: 'Star',
      starDesc: 'Popular & high profit — keep and promote',
      plowhorse: 'Popular',
      plowhorseDesc: 'Sells well but low profit — raise price or cut costs',
      puzzle: 'Hidden gem',
      puzzleDesc: 'High profit but low sales — promote and upsell',
      dog: 'Needs review',
      dogDesc: 'Low sales & low profit — consider removing or reworking',
    },
    colName: 'Item',
    colPrice: 'Price',
    colCost: 'Cost',
    colMargin: 'Profit/item',
    colMarginPct: 'Margin %',
    colSold: 'Sold/month',
    colMonthlyProfit: 'Profit/month',
    colCategory: 'Category',
    noItems: 'No items yet. Go back to the Menu step to add items.',
  },

  // ─── Existing Mode: Benchmark Comparison ───
  benchmark: {
    title: 'Industry comparison',
    subtitle: 'Your numbers vs. typical ranges for similar F&B businesses.',
    metricLabels: {
      cogs: 'Ingredients',
      rent: 'Rent',
      labor: 'Staff',
      primeCost: 'Ingredients + Staff',
      netMargin: 'Net margin',
      revenuePerSeat: 'Revenue/seat/day',
    },
    yourValue: 'Yours',
    industryRange: 'Benchmark',
    statusGood: 'Good',
    statusWarn: 'Watch',
    statusBad: 'Needs work',
  },

  // ─── Existing Mode: Quick Wins ───
  quickWins: {
    title: 'Quick improvements',
    subtitle: 'Changes with the biggest impact, sorted by potential savings.',
    currentLabel: 'Current',
    targetLabel: 'Target',
    impactLabel: 'Savings/month',
    effortEasy: 'Easy',
    ...
    noWins: 'Great! All metrics look healthy, no urgent improvements needed.',
    // Quick win item keys
    rentTitle: 'Reduce rent costs',
    rentDesc: 'Rent is {pct}% of revenue — should be under {target}%.',
    rentAction: 'Renegotiate your lease or explore alternative locations.',
    cogsTitle: 'Lower ingredient costs',
    cogsDesc: 'Ingredients are {pct}% of revenue — should be under {target}%.',
    cogsAction: 'Negotiate with suppliers, optimize recipes, find alternatives.',
    wasteTitle: 'Reduce waste',
    wasteDesc: 'Waste is at {pct}% — should be under {target}%.',
    wasteAction: 'Better inventory management, first-in-first-out, portion control.',
    laborTitle: 'Optimize staffing',
    laborDesc: 'Staff costs are {pct}% of revenue — should be under {target}%.',
    laborAction: 'Flexible scheduling, focus staff on peak hours.',
    deliveryLossTitle: 'Delivery channel losing money',
    deliveryLossDesc: 'Delivery app is losing {amount}/month after commission + packaging.',
    deliveryLossAction: 'Raise delivery prices, negotiate lower commission, or switch to own delivery.',
    menuDogsTitle: 'Remove or rework underperforming items',
    menuDogsDesc: '{count} items have both low sales and low profit.',
    menuDogsAction: 'Replace with new items or adjust pricing & recipes.',
    pushStarsTitle: 'Promote your star items',
    pushStarsDesc: '{count} items are popular & profitable — boost sales by 15%.',
    pushStarsAction: 'Feature prominently on menu, upsell, create combos.',
    pricingTitle: 'Small price increase',
    pricingDesc: 'Net margin is only {pct}% — a 5% price increase won\'t lose customers.',
    pricingAction: 'Add combos, upsell options, or raise prices on low-margin items.',
  },
  ...
  chatScenario: {
    pickLabel: 'Select a scenario for AI context',
    pickPlaceholder: '-- None (general chat) --',
    loadingScenario: 'Loading scenario...',
    contextLoaded: 'AI has context from "{name}"',
    noScenarios: 'No scenarios yet. Validate a model first.',
  },

  // ─── Scenario Compare ───
  scenarioCompare: {
    title: 'Compare Scenarios',
    pickHint: 'Select 2-3 scenarios to compare side by side.',
    compareBtn: 'Compare',
    tabKPI: 'KPIs',
    tabChart: 'Charts',
    metric: 'Metric',
    score: 'Feasibility Score',
    revenue: 'Revenue (stable)',
    profit: 'Net Profit',
    margin: 'Net Margin',
    ...
    months: 'months',
    noPayback: '>12 months',
    profitOverlay: '12-Month Profit',
    revenueOverlay: '12-Month Revenue',
    reset: 'Select different scenarios',
  },

  // ─── Existing Sensitivity ───
  existingSensitivity: {
    subtitle: 'Drag the sliders to see how profit changes when you adjust each metric.',
    revenue: 'Revenue',
    cogs: 'COGS',
    rent: 'Rent',
    staff: 'Staff',
  ...
  // ─── Impact Projection ───
  impactProjection: {
    subtitle: 'If you implement the suggested improvements, here are the projected results.',
    current: 'Current',
    projected: 'After improvements',
    profit: 'Profit',
    margin: 'Net margin',
    totalSavings: 'Total projected savings',
    perMonth: 'month',
    perYear: 'year',
  },
};
