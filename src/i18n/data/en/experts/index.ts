...
const EXPERTS: Expert[] = [
...

  {
    ...
    definition: 'Đào Thế Vinh (born 1972) is Chairman and CEO of Golden Gate, Vietnam\'s largest restaurant chain with over 500 restaurants across 40+ brands (Kichi-Kichi, GoGi House, Manwah, Hutong) and VND 6,630 billion in 2024 revenue. He trained as a meteorology engineer in Russia and entered F&B with zero culinary experience, founding Golden Gate in 2008. Temasek valued the company at $650M; Mekong Capital exited at a 9.1x return.',
...

  {
    ...
    definition: 'Phạm Cao Vinh (born 1968) is Chairman of Goldsun Group, operator of one of Vietnam\'s largest F&B chains with 16 brands (Kichi-Kichi, GoGi House early years, Ashima) and over 200 restaurants serving 2.4 million customers annually. He started in liquefied gas in 1994, became a Tier-1 Samsung vendor supplying ~20% of Samsung phone packaging, then expanded into F&B via Goldsun Food from 2008.',
...

  {
    ...
    definition: 'Lý Quý Trung (born 1966) is the founder of Pho 24 (2003), regarded as the "father" of F&B franchising in Vietnam, with 70+ stores across 5 countries. He sold Pho 24 to Highlands Coffee Group for $20 million in 2011. He is currently CEO of Nha Xinh, a professor at Western Sydney University, and the author of 10 business books on F&B and franchising.',
...

  {
    ...
    definition: 'Hoàng Tùng (born Feb 8, 1980), widely known as "Mr Pizza", is the founder of Pizza Home (~20 stores in Hanoi) and Cloud Cook — a cloud-kitchen operation running 50+ ghost brands. He gained global attention in 2020 with the "Corona Burger", covered by CNN, BBC, and Reuters. On Shark Tank Vietnam S4, he raised VND 6 billion for 40% of Cloud Cook.',
...

  {
    ...
    definition: 'Nguyễn Thị Kim Oanh (born 1975) is the founder of Wrap & Roll (2006), a pioneering restaurant chain that reframed traditional Vietnamese spring rolls into a modern format, with 12 stores in Vietnam, 4 franchise locations in Singapore, and $6.9 million in raised investment. Before entering F&B, she was crowned Vietnam\'s first Miss Athletic in 1993. She represented Asian female entrepreneurs at the 2016 Ernst & Young Winning Women awards.',
