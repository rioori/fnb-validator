  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          { label: 'Vùng I', range: '5.31 triệu/tháng', note: 'TP.HCM, Hà Nội, các quận trung tâm. Lương theo giờ: 25.500đ. Nguồn: [Thư Viện Pháp Luật](https://thuvienphapluat.vn/phap-luat-doanh-nghiep/bai-viet/muc-luong-toi-thieu-vung-2026-muc-luong-co-so-2026-va-mot-so-luu-y-quan-trong-18204.html).' },
      ...
      },
      {
        ...
        content: [
          { label: 'Phục vụ (waiter)', range: '5.3-13tr', note: 'Entry 5.3-8tr, có kinh nghiệm 1-2 năm 7-10tr + tip, senior 3+ năm 10-13tr + tip. Nguồn: [CareerLink](https://www.careerlink.vn/cam-nang-luong/muc-luong-nganh-f-b/) + [ViecLamTot](https://www.vieclamtot.com/kinh-nghiem/luong-nhan-vien-phuc-vu-co-du-song.html).' },
          { label: 'Barista / pha chế', range: '6-20tr', note: 'Entry 6-8tr, junior 8-10tr, senior 10-12tr. Specialty coffee shop hoặc có cert: 12-20tr. Nguồn: [Hoàng Hiệp Coffee](https://hoanghiepcoffee.com/muc-luong-cua-nguoi-tho-barista-la-bao-nhieu) + [Coffee Club](https://thecoffeeclub.com.vn/luong-pha-che-bao-nhieu-cap-nhat-muc-thu-nhap-nghe-barista).' },
          { label: 'Phụ bếp / tạp vụ', range: '4.5-10tr', note: 'Entry 4.5-6tr, có kinh nghiệm 6-8tr, senior 7-10tr. Mức tăng nhanh khi chuyển lên line cook. Nguồn: [NhanSu.vn](https://nhansu.vn/thi-truong-lao-dong/tam-diem-thi-truong/nam-2025-muc-luong-nhan-vien-phu-bep-len-den-15-trieu-dong-26313.html).' },
          { label: 'Đầu bếp (line cook / chef de partie)', range: '7-20tr', note: 'Entry 7-10tr, mid 10-15tr, senior 12-20tr. Hot kitchen (wok, grill) lương cao hơn cold. Nguồn: [ToanPhat Corp](https://toanphatcorp.vn/luong-dau-bep-o-viet-nam/) + [Saigon Tourist](https://saigontourist.edu.vn/luong-dau-bep-hien-nay-bao-nhieu-muc-luong-theo-vi-tri-chi-tiet.html).' },
          { label: 'Bếp trưởng / sous chef', range: '12-40tr', note: 'Entry 12-18tr, mid 20-30tr, senior 25-40tr. Nhà hàng chains lớn vào range cao. Nguồn: [JobsGO](https://jobsgo.vn/muc-luong-bep-truong.html).' },
          { label: 'Bếp trưởng chính (head/exec chef)', range: '25-100tr+', note: 'Nhà hàng thường 25-50tr, khách sạn 5-sao + nhà hàng award 50-100tr+. Top chefs (TV, sao Michelin) 150tr+. Nguồn: [HTT Master](https://httmaster.edu.vn/muc-luong-dau-bep-tai-viet-nam-va-quoc-te/).' },
          { label: 'Trưởng ca / shift supervisor', range: '7-18tr', note: 'Entry 7-12tr, có kinh nghiệm 10-15tr, senior 12-18tr. Thường cộng thêm 1-2tr/tháng so với phục vụ giỏi. Nguồn: [HotelJob](https://www.hoteljob.vn/tin-tuc/shift-leader-la-gi).' },
          { label: 'Quản lý nhà hàng', range: '12-50tr', note: 'Quán nhỏ 12-18tr, chuỗi nhà hàng 18-30tr, fine dining hoặc chain lớn 25-50tr. Nguồn: [TopCV](https://www.topcv.vn/tra-cuu-muc-luong-tai-viet-nam/quan-ly-nha-hang) + [VietnamWorks](https://www.vietnamworks.com/quan-ly-nha-hang-kv).' },
          { label: 'Quản lý khu vực (area/multi-unit)', range: '30-80tr', note: 'Quản 3-10 cửa hàng. Thường cộng % bonus theo P&L của khu vực.' },
          { label: 'Thợ làm bánh (baker)', range: '4-15tr', note: 'Entry 4-5tr, có kinh nghiệm 6-8tr, senior 8-12tr. Specialty bakery (croissant, sourdough): 9-15tr. Nguồn: [1900.com.vn](https://1900.com.vn/muc-luong/tho-lam-banh-3279).' },
        ] as KBTableRow[],
      },
      {
        type: 'text',
