...
const COST_ARTICLES: KBTopic[] = [
  ...
  },
  {
    ...
    seoTitle: 'GrabFood vs ShopeeFood 2026: App nào rẻ hơn? So sánh phí hoa hồng',
    seoDescription: 'GrabFood 25-30%, ShopeeFood 22-27%, GoFood 20-25% — ShopeeFood rẻ hơn Grab 3-5%. Cộng bao bì 3-8K/đơn, biên lợi nhuận thực chỉ 5-12%. So sánh chi tiết + khi nào tự giao hàng lời hơn.',
    color: 'primary-light',
    category: 'cost',
    highlights: [
