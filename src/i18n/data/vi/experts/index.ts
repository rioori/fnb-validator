...
const EXPERTS: Expert[] = [
...

  {
    ...
    slug: 'do-duy-thanh',
    name: 'Đỗ Duy Thanh',
    seoTitle: 'Đỗ Duy Thanh — Cha đẻ mô hình 9Ps, tư vấn 100+ chuỗi F&B (Vingroup, Gojek, Baemin)',
    seoDescription: 'Đỗ Duy Thanh — Sáng lập FnB Director + Horeca Business School. 20+ năm tư vấn chiến lược F&B cho Vingroup, Saigon Tourist, Nova FnB, Gojek, Baemin. Tác giả 9Ps Restaurant Management.',
...

  {
    ...
    slug: 'ha-chu',
    name: 'Hà Chu',
    seoTitle: 'Hà Chu (Chu Hồng Hà, 1992) — Founder COOKED, trường Marketing F&B đầu tiên VN',
    seoDescription: 'Hà Chu — sáng lập COOKED (2018), 100.000 học viên Marketing F&B. Host podcast "Ha Chu works" 97 tập, 4.9★ Spotify. Tư vấn Gia Michelin, The KAfe. Triết lý "khẩu vị là điểm chạm".',
...

  {
    ...
    seoTitle: 'Trần Trung Hiếu "F&B Coach" — tư vấn 1000+ chủ quán cafe & nhà hàng nhỏ',
    seoDescription: 'Trần Trung Hiếu — chuyên gia tư vấn F&B cho chủ quán nhỏ. Phương pháp coaching thực chiến cho cafe + nhà hàng. Bài học từ 1000+ case thật.',
...

  {
    ...
    definition: 'Đào Thế Vinh (sinh 1972) là Chủ tịch và CEO Golden Gate, chuỗi nhà hàng lớn nhất Việt Nam với hơn 500 nhà hàng thuộc 40+ thương hiệu (Kichi-Kichi, GoGi House, Manwah, Hutong, ...) và doanh thu 6.630 tỷ VNĐ năm 2024. Ông tốt nghiệp kỹ sư khí tượng tại Nga và bước vào F&B với 0 kinh nghiệm bếp, sáng lập Golden Gate năm 2008. Temasek định giá công ty $650 triệu; Mekong Capital thoái vốn với tỷ suất 9.1x.',
...

  {
    ...
    slug: 'tran-le-nguyen',
    name: 'Trần Lệ Nguyên',
    seoTitle: 'Trần Lệ Nguyên (1968) — CEO KIDO Group, bán Kinh Đô cho Mondelez $490M',
    seoDescription: 'Trần Lệ Nguyên — đồng sáng lập Kinh Đô, bán mảng bánh kẹo $370-490 triệu (2014). Dẫn đầu kem Việt 47%, #2 dầu ăn. Vì sao Chuk Chuk thất bại sau 18 tháng?',
...

  {
    ...
    definition: 'Danny Le (sinh 1984) là CEO Masan Group từ năm 2020, một trong những CEO trẻ nhất của tập đoàn lớn tại Việt Nam. Ông là Việt kiều Mỹ, cựu investment banking analyst tại Morgan Stanley, và là người kiến trúc thương vụ mua 85% Phúc Long Heritage định giá $455 triệu. Dưới thời ông, Masan huy động hơn $5 tỷ từ KKR, Alibaba, SK Group và Bain Capital.',
...

  {
    ...
    slug: 'pham-cao-vinh',
    name: 'Phạm Cao Vinh',
    seoTitle: 'Phạm Cao Vinh — Chủ tịch Goldsun, từ bao bì Samsung đến 16 thương hiệu F&B, 200+ NH',
    seoDescription: 'Phạm Cao Vinh — Chủ tịch Goldsun Group. Đi lên từ bao bì cho Samsung, xây 16 thương hiệu F&B (Kichi-Kichi, GoGi House đời đầu), 200+ nhà hàng. Multi-brand strategy.',
    descriptor: 'Chủ tịch Goldsun Group — xây đế chế từ bao bì Samsung đến 16 thương hiệu F&B, 200+ nhà hàng',
    definition: 'Phạm Cao Vinh (sinh 1968) là Chủ tịch Goldsun Group, người xây dựng một trong những chuỗi F&B lớn nhất Việt Nam với 16 thương hiệu (Kichi-Kichi, GoGi House đời đầu, Ashima) và hơn 200 nhà hàng phục vụ 2.4 triệu khách mỗi năm. Ông bắt đầu từ ngành gas hóa lỏng năm 1994, trở thành vendor cấp 1 cung cấp ~20% bao bì điện thoại cho Samsung, rồi mở rộng sang F&B qua Goldsun Food từ 2008.',
...

  {
    ...
    seoTitle: 'Nguyễn Hải Ninh (1987) — Founder The Coffee House, M Village, Every Half',
    seoDescription: 'Nguyễn Hải Ninh — 4 ventures trong 14 năm: Urban Station, The Coffee House (175 quán, Forbes 30U30), M Village ($10M), Every Half ($3M). Bí quyết khởi nghiệp & gọi vốn.',
    descriptor: '"Nhà khởi nghiệp nối tiếp" — từ Urban Station đến The Coffee House, M Village và Every Half',
    definition: 'Nguyễn Hải Ninh (sinh 1987) là một trong những nhà khởi nghiệp F&B nổi bật nhất Việt Nam, đồng sáng lập Urban Station, sáng lập The Coffee House (175 quán, được Forbes 30 Under 30 vinh danh), M Village (huy động $10 triệu), và Every Half (huy động $3 triệu). Anh được biết đến với triết lý "làm brand tử tế" và khả năng gọi vốn từ các quỹ đầu tư quốc tế.',
...

  {
    ...
    slug: 'ngo-nguyen-kha',
    name: 'Ngô Nguyên Kha',
    seoTitle: 'Ngô Nguyên Kha — CEO The Coffee House, từ Sony Ericsson Country Manager đến chuỗi cà phê',
    seoDescription: 'Ngô Nguyên Kha — CEO The Coffee House. Country Manager Sony Ericsson Vietnam, sáng lập Mobiistar (hãng smartphone Việt), hiện dẫn dắt 175+ cửa hàng cà phê.',
    descriptor: 'CEO The Coffee House — từ Country Manager Sony Ericsson, sáng lập Mobiistar đến dẫn dắt chuỗi cà phê lớn',
    definition: 'Ngô Nguyên Kha (sinh 1971) là CEO The Coffee House từ tháng 12/2021, người mang tư duy công nghệ và trải nghiệm khách hàng từ ngành điện tử vào F&B Việt Nam. Ông từng là Country Manager Sony Ericsson Vietnam và đồng sáng lập Mobiistar — thương hiệu smartphone Việt từng vào top 5 thị phần. Đầu 2025, Golden Gate mua lại 99.98% The Coffee House với giá 270 tỷ VNĐ dưới thời ông lãnh đạo.',
...

  {
    ...
    definition: 'Lý Quý Trung (sinh 1966) là người sáng lập Phở 24 năm 2003, được xem là "cha đẻ" của nhượng quyền F&B Việt Nam với 70+ cửa hàng tại 5 quốc gia. Ông bán Phở 24 với giá $20 triệu cho Highlands Coffee Group năm 2011. Hiện ông là CEO Nhà Xinh, Giáo sư tại Đại học Western Sydney, và tác giả của 10 cuốn sách kinh doanh về F&B và nhượng quyền.',
...

  {
    ...
    slug: 'nguyen-ha-linh',
    name: 'Nguyễn Hà Linh',
    seoTitle: 'Nguyễn Hà Linh (1988) — Founder Koh Yam Thai, Nghiện Nhà 2.6 triệu thành viên',
    seoDescription: 'Nguyễn Hà Linh — Forbes 30U30. Từ 250.000đ tuổi 18 đến chuỗi Bếp Thái Koh Yam 10 chi nhánh. Bài học sau cú lỗ 7 tỷ với kem dừa Koh Samui.',
...

  {
    ...
    definition: 'Hoàng Tùng (sinh 8/2/1980), thường được gọi "Mr Pizza", là người sáng lập Pizza Home (chuỗi ~20 quán tại Hà Nội) và Cloud Cook — mô hình bếp đám mây vận hành 50+ ghost brand. Ông nổi tiếng toàn cầu với Burger Corona năm 2020 được CNN, BBC và Reuters đưa tin. Trên Shark Tank Vietnam S4, ông gọi vốn 6 tỷ VNĐ cho 40% cổ phần Cloud Cook.',
...

  {
    ...
    seoTitle: 'Đặng Lê Nguyên Vũ (1971) — Chủ tịch Trung Nguyên, "Vua cà phê Việt"',
    seoDescription: 'Đặng Lê Nguyên Vũ — bỏ học Y khoa, xây Trung Nguyên Legend ra 60+ quốc gia. G7 chiếm 38% thị phần cà phê hòa tan VN. Forbes Asia "Zero to Hero".',
...

  {
    ...
    definition: 'Nguyễn Thị Kim Oanh (sinh 1975) là người sáng lập Wrap & Roll năm 2006, chuỗi nhà hàng tiên phong đưa món cuốn truyền thống Việt vào mô hình hiện đại với 12 cửa hàng tại Việt Nam, 4 nhượng quyền tại Singapore và huy động 6.9 triệu USD đầu tư. Trước khi làm F&B, bà là Hoa khôi Thể thao đầu tiên của Việt Nam năm 1993. Bà đại diện nữ doanh nhân châu Á tại giải Ernst & Young Winning Women năm 2016.',
